...
class User(ScaffoldModel, StateModel, TimestampMixin, MaintainMixin):
    ...
    is_superuser = fields.BooleanField(default=False, db_index=True, description="是否为超级管理员")
    last_login = fields.DatetimeField(null=True, db_index=True, description="最后一次登陆时间")
