...
class Audit(ScaffoldModel, MaintainMixin, TimestampMixin):
    ...
    username = fields.CharField(max_length=32, db_index=True, description="用户名称")
    request_time = fields.DatetimeField(db_index=True, description="请求时间")
    request_tags = fields.CharField(max_length=255, default="", null=True, db_index=True, description="请求模块")
    request_summary = fields.CharField(max_length=255, default="", null=True, db_index=True, description="请求接口")
    request_method = fields.CharEnumField(HTTPMethod, db_index=True, description="请求方式")
    request_router = fields.CharField(max_length=255, db_index=True, description="请求路由")
    ...
    response_time = fields.DatetimeField(db_index=True, description="响应时间")
    response_header = fields.JSONField(default=None, null=True, description="响应头部")
    response_code = fields.CharField(max_length=16, default="", null=True, db_index=True, description="响应代码")
